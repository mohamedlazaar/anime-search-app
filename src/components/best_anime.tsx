...
}, {  scope:containerRef, dependencies: [animeList, loading] });

  useEffect(() => {
    const controller = new AbortController();
    setLoading(true);
    
    const url = 'https://api.themoviedb.org/3/discover/movie?include_adult=true&page=12&with_origin_country=JP&with_genres=16';
